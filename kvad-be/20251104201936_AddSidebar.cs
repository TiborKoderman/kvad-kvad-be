    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Sidebar = table.Column<List<SidebarItem>>(type: "jsonb", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AdditionalHealth = table.Column<JsonDocument>(type: "jsonb", nullable: true),
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { "A", null, new[] { (short)0, (short)0, (short)0, (short)1, (short)0, (short)0, (short)0 }, new[] { 1L, 1L }, "Ampere", true, "Electric Current", "linear" },
                { "cd", null, new[] { (short)0, (short)0, (short)0, (short)0, (short)0, (short)0, (short)1 }, new[] { 1L, 1L }, "Candela", true, "Luminous Intensity", "linear" },
                { "K", null, new[] { (short)0, (short)0, (short)0, (short)0, (short)1, (short)0, (short)0 }, new[] { 1L, 1L }, "Kelvin", true, "Temperature", "linear" },
                { "kg", null, new[] { (short)0, (short)1, (short)0, (short)0, (short)0, (short)0, (short)0 }, new[] { 1L, 1L }, "Kilogram", true, "Mass", "linear" },
                { "m", null, new[] { (short)1, (short)0, (short)0, (short)0, (short)0, (short)0, (short)0 }, new[] { 1L, 1L }, "Meter", true, "Length", "linear" },
                { "mol", null, new[] { (short)0, (short)0, (short)0, (short)0, (short)0, (short)1, (short)0 }, new[] { 1L, 1L }, "Mole", true, "Amount of Substance", "linear" },
                { "s", null, new[] { (short)0, (short)0, (short)1, (short)0, (short)0, (short)0, (short)0 }, new[] { 1L, 1L }, "Second", true, "Time", "linear" }
            });

        migrationBuilder.InsertData(
            table: "Users",
            columns: new[] { "Id", "Icon", "Password", "PrivateGroupId", "Sidebar", "Username" },
            values: new object[] { new Guid("cf960f59-cf1f-49cc-8b2c-de4c5e437730"), "data/user_icons/cf960f59-cf1f-49cc-8b2c-de4c5e437730.png", "$argon2id$v=19$m=32768,t=4,p=1$g8fJIqwvK69pwVZEFI2+NQ$X5P9Sd32U7UTUJmjFP/t6P5vW/7lNS/RQYLE3nPbvXU", new Guid("cf960f59-cf1f-49cc-8b2c-de4c5e437730"), new List<SidebarItem>(), "admin" });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { new Guid("00000000-0000-0000-0000-000000000001"), "This is a virtual device for testing purposes.", 11, "Lab", null, "Virtual Device 1", new Guid("cf960f59-cf1f-49cc-8b2c-de4c5e437730"), "Virtual", true },
                { new Guid("504b1696-2ad5-4109-ac28-5158965d6675"), "This is a physical test device.", 11, "Office", null, "Esp32 Test Device", new Guid("cf960f59-cf1f-49cc-8b2c-de4c5e437730"), "Physical", false }
            });
        ...
        migrationBuilder.InsertData(
            table: "DeviceState",
            columns: new[] { "DeviceId", "AdditionalHealth", "BootId", "ConfigHash", "Connectivity", "Extra", "Flags", "HbIntervalSec", "HbJitterPct", "Health", "LastHeartbeat", "Mode", "Rssi", "Seq", "UptimeSec" },
            values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), null, null, null, 5, null, null, 10, (short)20, 3, null, 8, null, 0L, 0 });
