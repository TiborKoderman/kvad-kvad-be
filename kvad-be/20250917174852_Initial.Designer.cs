...
[Migration("20250917174852_Initial")]
                    ...
                    b.ToTable("EnumUnitDimensions", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_enumunitdimension_sequential_ids", "(\"Id\" = 0) OR EXISTS (SELECT 1 FROM \"EnumUnitDimensions\" e WHERE e.\"Id\" = \"EnumUnitDimensions\".\"Id\" - 1)");
                        });
